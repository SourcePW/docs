...
生成java头文件`javah`, 在`src/main/java`文件夹下执行指令:    
```
javah -jni com.example.JniDemo 
```  
生成`com_example_JniDemo.h`文件 
```
 ...
 * Signature: ([B)[B
 */
JNIEXPORT jbyteArray JNICALL Java_com_example_JniDemo_jntCall
